...
<title>Internal Blog - Login</title>
...
<h2 class="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Internal Blog</h2>
</div>
</header>
...
<div class="bg-white dark:bg-[#231a2e] rounded-xl shadow-sm border border-slate-200 dark:border-[#362447] p-6 md:p-8 flex flex-col gap-6">
...
<input class="w-full bg-transparent border-none text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-text-muted h-12 px-4 focus:ring-0 text-base font-normal leading-normal" placeholder="Enter your email" type="text"/>
</div>
</div>
<div class="flex flex-col gap-2"> 
...
<input class="w-full flex-1 bg-transparent border-none text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-text-muted h-12 px-4 focus:ring-0 text-base font-normal leading-normal" placeholder="Enter your password" type="password"/>
<button class="pr-4 text-slate-400 dark:text-text-muted hover:text-primary flex items-center justify-center transition-colors focus:outline-none">
...
<p class="text-center text-slate-500 dark:text-text-muted text-sm">
                ...
                <a class="text-primary hover:text-primary/80 font-semibold transition-colors" href="#">Sign up</a>
</p>
</div>
</main>
</body></html>
